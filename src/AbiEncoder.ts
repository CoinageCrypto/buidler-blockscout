...
export default class AbiEncoder {
	public static encodeConstructor(contractAbi: any[], constructorArguments: string[]): string {
		let constructorAbis: any[] = contractAbi.filter((value) => value.type === 'constructor');
