...
import { BlockscoutBuidlerEnvironment } from '../index';

export default class BlockscoutVerifyContractRequest {
	// for that weird blockscout library props (which copy the etherscan ones)
	[key: string]: any;
	...
	constructor(
		blockscoutConfig: BlockscoutBuidlerEnvironment,
